...
$('#logoutButton').addEventListener('click', async () => { await supabaseClient.auth.signOut(); clearInterval(notificationPollingId); notificationPollingId = null; unreadNotificationCount = null; notificationLoadErrorShown = false; currentUser = null; $('#appScreen').classList.add('hidden'); $('#authScreen').classList.remove('hidden'); });
$('#mobileLogout').addEventListener('click', async () => { await supabaseClient.auth.signOut(); clearInterval(notificationPollingId); notificationPollingId = null; unreadNotificationCount = null; notificationLoadErrorShown = false; currentUser = null; $('#appScreen').classList.add('hidden'); $('#authScreen').classList.remove('hidden'); });
