...
<body>
    ...
    <main class="app-shell hidden" id="appScreen">
        ...
        <section class="content-area">
            <header class="topbar"><div class="mobile-brand"><span class="mini-logo">PT</span> Programação Tênis</div><div class="topbar-actions"><button class="icon-button" title="Notificações">♢<i></i></button><div class="user-menu"><div class="avatar" id="userAvatar">VC</div><div><strong id="userName">Visitante</strong><small id="userRole">Membro</small></div></div></div></header>
